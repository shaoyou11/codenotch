...
enum Typography {
    ...
    static let cardTitle = Font.system(size: max(12, Design.fontSize(capPixels: 26)), weight: .semibold)

    /// "Current session", "73% Used", "Resets in 51 min". Cap height 18px.
    static let cardBody = Font.system(size: max(11, Design.fontSize(capPixels: 18)), weight: .regular)
}
